...
/*
 * ------------------------------------------------------
 *  Load the namespace constants
 * ------------------------------------------------------
 */
	if (defined('ENVIRONMENT') AND file_exists(APPPATH.'config/'.ENVIRONMENT.'/namespaces.php'))
	{
		require(APPPATH.'config/'.ENVIRONMENT.'/namespaces.php');
	}
	else
	{
		require(APPPATH.'config/namespaces.php');
	}
//ENDEDIT
